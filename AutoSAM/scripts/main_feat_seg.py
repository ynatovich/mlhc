...
from AutoSAM.models import sam_feat_seg_model_registry
from AutoSAM.dataset import generate_dataset, generate_test_loader
from AutoSAM.evaluate import test_synapse, test_acdc
